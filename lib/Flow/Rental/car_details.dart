                                        ...
                                        Row(
                                          children: [
                                            Image.asset(
                                              ...
                                              width: 22.sp.clamp(20.0, 24.0),
                                              height: 22.sp.clamp(20.0, 24.0),
                                              fit: BoxFit.contain,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        SizedBox(height: 41.h),
                                        Text(
                                            'סך הכל לתשלום     ${(rentPrice + additionsPrice).round()} ₪',
                                            style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 18.sp)),
                                        SizedBox(height: 7.h),
                                                  ...
                                                  children: [
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        SizedBox(height: 17.h),
                                                        Text(
                                                            '₪ ${((rentPrice + additionsPrice) * 0.18).round()}',
                                                            style: TextStyle(
                                                                fontSize: 16.sp,
                                                                fontWeight:
                                                                    FontWeight
                                                        ...
                                                        SizedBox(height: 17.h),
                                                        Text(
                                                            '₪ ${(rentPrice + additionsPrice).round()}',
                                                            style: TextStyle(
                                                                fontSize: 16.sp,
                                                                fontWeight:
                                                                    FontWeight
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    if (!widget.rent.additions![index].title.contains("50"))
                      Text(
                        'ליום',
