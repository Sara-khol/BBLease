...
Future rentalTerm(context, nav, [DateTime? s, DateTime? e]) {
  ...
  final iconSize = calendarIconSize(context);
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: TextFormField(
                                    ...
                                    cursorColor:
                                        const Color.fromRGBO(15, 17, 21, 1),
                                    decoration: getInputDecoration1('', 192,
                                      suffixIcon: Padding(
                                ...
                                Expanded(
                                  ...
                                  child: TextFormField(
                                      cursorColor:
                                          const Color.fromRGBO(15, 17, 21, 1),
                                      decoration: getInputDecoration1(
                                        '',
                                        131,
                                        suffixIcon: Padding(
                                          padding: EdgeInsets.only(left: 8.w),
...
Future showLoading(BuildContext context, [dismiss = true]) {
  return showDialog(
    context: context,
...
double calendarIconSize(BuildContext context) {
