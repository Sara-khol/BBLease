...
class _OrdersHistoryState extends State<OrdersHistory> {
  ...
  late DateTime e;
   ...
   getOrders() async{
    print('getUsersList()');
    await ApiService().getUserOrders(772, (rent) {
                            ...
                            child: Column(
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text('סנן הזמנות לפי תאריך  ', style: TextStyle(
                                        fontSize: 22.sp,
                                        fontWeight: FontWeight.w700,
                                        color: Colors.black),),
                                    Icon(Icons.calendar_today_outlined, color: const Color(0xFFFB2576), size: 24.sp,),
                                  ],
                                ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text('ממתי ?',style: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w700, color: Colors.black)),
                                  ],
                                ),
                                TextFormField(
                                  readOnly: true,
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed: () =>setState((){}),
                                      child: const Text('הצג', style: TextStyle(
                                          fontSize: 22,
      ...
      body: Directionality(
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              width: 332.w,
                ...
                ElevatedButton(
                    ...
                    child: Text('הזמנה נוכחית',style: TextStyle(fontSize: 22.sp, fontWeight: FontWeight.w500),)
                ),
            ),
            ...
            Row(
              children: [
                ...
                OutlinedButton(
                  ...
                  child: Row(
                    children: [
                      Text('סנן לפי תאריך  ',style: TextStyle(fontSize: 18.sp),),
                      Icon(Icons.filter_alt_outlined,color: Color(0xFFFB2576),)
                    ],
                  )
                )
              ],
            ...
            SizedBox(height: 20.h,),
            orders.isNotEmpty?MediaQuery.removePadding(
              removeTop: true,
              context: context,
              child: ListView.builder(
                  ...
                  if(rent.startDate.isBefore(e)
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => OrderDetails(rent: rent,),)
                      );
                    },
                    child: Container(
                      width: 332.w,
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Text(intl.DateFormat('dd.MM.yy').format(rent.startDate),style: TextStyle(fontSize: 22.sp,fontWeight: FontWeight.w300),),
                            Spacer(),
                            const Icon(Icons.file_download,color: Color(0xFFFB2576),)
            ...
            Container(
              ...
              ElevatedButton(
                  ...
                  onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => WelcomeForm(),)
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('חזרה לתפריט ראשי   ',style: TextStyle(fontSize: 22.sp, fontWeight: FontWeight.w500,color: Colors.white),),
