...
class _PersonalDetailsFormState extends State<PersonalDetailsForm> {
  ...
  TextEditingController _firstName=TextEditingController(text: User().firstName);
  TextEditingController _lastName=TextEditingController(text: User().lastName);
  TextEditingController _name=TextEditingController(text: User().firstName+ ''+User().lastName);
  TextEditingController _id=TextEditingController(text: User().id);
  TextEditingController _date=TextEditingController(text: intl.DateFormat('dd-mm-yyyy').format(User().birthDate));
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(backgroundColor: Color.fromRGBO(0, 222, 222, 1),
                        ...
                        child: Text('הבא',style: TextStyle(fontSize: 18.sp, fontWeight: FontWeight.w500,fontFamily: 'PLONI'),)),
                  ),
