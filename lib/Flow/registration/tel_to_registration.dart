  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: LandSpaceWidget(
        ...
        imageProperties: ImageProperties('l_image.png', 580.w, 'תמונת כניסה'),
        showAppBar: false),
    );
  }
              ...
              child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _isLoading
                        ? Colors.grey
                        : (_phone.text.length < 10 || !checkboxValue1
                            ? Colors.grey
                            : turquoiseColorApp),
